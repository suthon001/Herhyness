/// <summary>
/// Report Report Sales Invoice (ID 70003).
/// </summary>
report 70003 "MRC Sales Invoice (Post)"
{
    Caption = 'Sales Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_70003_SalesInvoicePosted.rdl';
    ...
    dataset
    {
        dataitem(SalesHeader; "Sales Invoice Header")
        {
            ...
            column(companyInfor_BankAccountName; companyInfor."MRC Bank Account Name") { }
            column(companyInfor_BankAccountNo; companyInfor."Bank Account No.") { }
            column(companyInfor_BankNameThai; companyInfor."Bank Name") { }
            column(companyInfor_BankNameEng; companyInfor."MRC Bank Name Eng") { }
            column(companyInfor_BankBranchNameThai; companyInfor."MRC Bank Branch Name Thai") { }
            column(companyInfor_companyInfor_BankBranchNameEng; companyInfor."MRC Bank Branch Name Eng") { }
            ...
            column(DimensionSetEntry_SalesChanel; DimensionSetEntry."Dimension Value Name") { }
            ...
            begin
                ...
                if not DimensionSetEntry.GET("Dimension Set ID", 'SALES_CHANNEL') then
