/// <summary>
/// Report Report MRC Sales Credit Memo (ID 70000).
/// </summary>
report 70000 "MRC Sales Credit Memo (Post)"
{
    Caption = 'Sales Credit Memo';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_70000_SalesCreditMemoPosted.rdl';
